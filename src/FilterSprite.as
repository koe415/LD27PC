package 
{
	...
	public class FilterSprite extends FlxSprite
	{
		...
		public static var FILTER_BLUR1:int = 2;
		public static var FILTER_BLUR2:int = 3;
		public static var FILTER_BLUR3:int = 4;
		public static var FILTER_BLUR4:int = 5;
		...
		public static function initializeFilters():void
		{
			...
			FILTERS[FILTER_BLUR1] = new BlurFilter(1, 1, 1);
			FILTERPOINTS[FILTER_BLUR1] = new Point( -2, -2);
			FILTERS[FILTER_BLUR2] = new BlurFilter(2, 2, 1);
			FILTERPOINTS[FILTER_BLUR2] = new Point( -2, -2);
			FILTERS[FILTER_BLUR3] = new BlurFilter(8, 8, 1);
			FILTERPOINTS[FILTER_BLUR3] = new Point( -2, -2);
			FILTERS[FILTER_BLUR4] = new BlurFilter(16, 16, 1);
			FILTERPOINTS[FILTER_BLUR4] = new Point( -2, -2);
